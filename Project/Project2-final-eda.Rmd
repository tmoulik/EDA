...
### Introduction
In this report, I am analyzing the Prosper Loan Data, using a  number of 
different visualizations which can be categorized as uni-variate, bi-variate 
and multivariate. A glimpse of the data shows that there are 81 variables 
and 113937 observations. For the sake of submission, I don't print all the 
variables. I explain the variables I chose, as I explain each section. The 
...
separate chunks. I have combined uni-variate, bi-variate and multivariate plots 
...
Let's print some of the variables here. 
...
Some of the variables in no particular preference or order, with large number 
of NA's are 
...
Before 2008, there are two peaks, Delinquency of about 2000 
...
now on. Unexpectedly, the PastDues (1-15), and (16-30) don't seem to have any 
...
One can see that the mean APR remains slightly above 0.25 and varies up to a 
...
from the size of the point. The mean APR remains fairly constant up to 640, 
...
One can see quite a bit of shape difference of the variables across credit 
ranges.
...
The mean varies between scores of 520 - 680, steadily rising, but 
...
charged-off vs Completed. But it does matter for those that defaulted, as for 
...
slightly lower for A,E,HA categories. The median DtoI ratio is slightly higher 
...
The second and third sub-plots essentially show the variation of the APR mean. 
...
There is a weak dependence of the CreditScore on Income. I chose this plot, 
...
positive correlation between credit score and borrowing rate. This led to 
...
financial world, and analyzing this dataset has sparked my curiosity to know 
more about this. 
